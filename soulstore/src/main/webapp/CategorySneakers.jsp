		...
		<div class="row">
			...
			if (products != null && !products.isEmpty()) {
				for (product p : products) {
					if (p.getCategory().equals("Sneaker")) {
			%>
			<div class="col-md-3 col-sm-2">
				<div class="card w-100" style="width: 18rem; height: 30rem">
					<div class="d-flex align-self-center justify-content-center mt-2"
						...
						<img class="card-img-top" src="./project-images/<%=p.getImage()%>"
							alt="<%=p.getName()%>">
					</div>
					<div class="card-body">
						...
						<div class="mt-3 d-flex justify-content-between">
							<a href="addtocart?id=<%=p.getId()%>" class="btn btn-dark">Add
								to cart</a> <a href="ordernow?quantity=1&id=<%=p.getId()%>"
